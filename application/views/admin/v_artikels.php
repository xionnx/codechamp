<section class="dark">
    <div class="container py-2">
        <div class="text-center text-dark">
            <h1>Daftar artikel pada Codechamp</h1>
        </div>
        ...
        <?php foreach ($artikel as $art) { ?>
            <article class="postcard dark purple mt-5">
                ...
                <div class="postcard__text t-light">
                    ...
                    <div class="postcard__preview-txt mt-3 ml-1"><?= substr($art->isi_artikel, 0, 300); ?> <b><br />Kunjungi detail artikel untuk baca lebih lengkapnya...</b></div>
