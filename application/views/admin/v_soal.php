        ...
        <div class="col-md-12">
            ...
            <div class="box box-success" style="overflow-x: scroll;">
                <div class="box-header">
                    ...
                    <center>
                        <div class="box-title">Tambah Soal Materi</div>
                    </center>
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea rows="2" style="width: 100%" name="jwb_a" required></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Jawaban B</label>
                                <div class="col-sm-10">
                                    <textarea rows="2" style="width: 100%" name="jwb_b" required></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Jawaban C</label>
                                <div class="col-sm-10">
                                    <textarea rows="2" style="width: 100%" name="jwb_c" required></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Jawaban D</label>
                                <div class="col-sm-10">
                                    <textarea rows="2" style="width: 100%" name="jwb_d" required></textarea>
                                </div>
                            </div>
                            <div class="form-group">
