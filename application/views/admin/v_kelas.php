  ...
  <div class="row">
    <div class="col-md-12">
      <div class="alert alert-danger alert-dismissible">
        ...
        Apabila Anda menghapus data kelas, maka data user yang ada pada data kelas tersebut akan terhapus!
      </div>
      ...
      <div class="box box-success" style="overflow-x: scroll;">
        <div class="box-header">
          ...
          <a href="<?=base_url('user')?>" class="btn btn-default btn-flat"><span class="fa fa-arrow-left"></span> Kembali</a>
