...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url('assets/'); ?>dist/css/css_beranda/card.css">
    ...
    <link rel="icon" type="image/x-icon" href="<?= base_url('assets/'); ?>dist/img/codechamplogo2.png">
</head>
