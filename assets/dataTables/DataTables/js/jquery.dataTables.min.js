...
(function (h) {
	...
	m.defaults = {
		...
		oLanguage: {
			...
			sEmptyTable: "Tidak ada satupun data pada tabel",
			sInfo: "Menampilkan _START_ sampai _END_ dari _TOTAL_ total",
			sInfoEmpty: "Menampilkan 0 sampai 0 dari 0 total",
			sInfoFiltered: "(filtered from _MAX_ total entries)",
			sInfoPostFix: "",
			sDecimal: "",
			sThousands: ",",
			sLengthMenu: "Tampilkan _MENU_ buah",
